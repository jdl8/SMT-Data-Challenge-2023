...
ggplot(player_pos_1903, aes(x = factor(player_position))) +
  geom_bar() +
...
ggplot(backing_up_second_count, aes(x = factor(position_backed_up))) +
  geom_bar() +
  scale_x_discrete(labels = c("Second Baseman", "Shortstop")) +
...
ggplot(player_pos_all, aes(x = factor(player_position))) +
  geom_bar() +
  scale_x_discrete(labels = c(1:19)) +
  labs(x = "Player Position", y = "Count")
...
ggplot(backing_up_second_count_all, aes(x = factor(position_backed_up))) +
  geom_bar() +
  scale_x_discrete(labels = c("Second Baseman", "Shortstop")) +
  labs(x = "Player Position", y = "Count", title = "How Often Did Each Position Back Up Second Base on Stolen Base Attempts?")
